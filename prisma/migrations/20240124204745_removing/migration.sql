/*
  ...
  - You are about to alter the column `outInfractionsLaunchDeadline` on the `schedule_rental` table. The data in that column could be lost. The data in that column will be cast from `Boolean` to `Int`.
